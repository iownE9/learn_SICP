...
def multiply_lnks(lst_of_lnks):
    ...
    for lnk in lst_of_lnks:
        new_first *= lnk.first
    return Link(new_first, multiply_lnks([lnk.rest for lnk in lst_of_lnks]))
...
def find_paths(t, entry):
    ...
    sub_paths = sum([find_paths(b, entry) for b in t.branches], [])

    return sum([[[t.label] + p] for p in sub_paths], [])
