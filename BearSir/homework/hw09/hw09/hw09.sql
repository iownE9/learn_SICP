...
CREATE TABLE by_parent_height AS
  SELECT child From parents, dogs WHERE parent = name ORDER BY height DESC; -- BearSir's
  -- mine
  -- SELECT c.name FROM dogs AS c, dogs AS p, parents WHERE c.name = child AND p.name = parent ORDER BY -p.height;
