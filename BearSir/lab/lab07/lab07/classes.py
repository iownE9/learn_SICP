...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        # "*** YOUR CODE HERE ***"
        # # ERROR!
        # # same attack or defense
        # # not both
        # targer, i = other_card.__repr__(), 0
        # while i < len(opponent.deck.cards):
        #     if opponent.deck.cards[i].__repr__() == targer:
        #         opponent.deck.cards.pop(i)
        #     else:
        #         i += 1

        # len_player_deck_cards, i = len(player.deck.cards), 0
        # while i < len_player_deck_cards:
